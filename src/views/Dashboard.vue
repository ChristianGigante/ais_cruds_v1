            ...
            <v-card-text>
              <v-container>
                <v-row>
                  ...
                  <v-col cols="12" sm="6" md="4">
                    <v-text-field v-model="editedItem.calories" label="Quantity" required type="number" min="1" ></v-text-field>
                  </v-col>
                  <v-col cols="12" sm="6" md="4">
                    <v-text-field v-model="editedItem.fat" label="Priority" required type="number" min="1" max="3"></v-text-field>
                  </v-col>
                  <!-- <v-col cols="12" sm="6" md="4">
